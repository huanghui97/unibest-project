...
/******/ var __webpack_modules__ = {
  ...
  /***/ 7588: /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    var forEachWithoutClosingOnEarlyError = iteratorHelperWithoutClosingOnEarlyError(
      'forEach',
      TypeError,
    )
...
var es_iterator_map = __webpack_require__(1701) // ./node_modules/@fluent/bundle/esm/types.js
class FluentType {
  constructor(value) {
    this.value = value
  }
...
var es_array_buffer_transfer_to_fixed_length = __webpack_require__(7936) // ./web/pdf_find_utils.js
const CharacterType = {
  SPACE: 0,
  ALPHA_LETTER: 1,
  PUNCT: 2,
